                ...
                <div class="hero container">
                    <div class="hero-copy">
                        ...
                        <div class="hero-buttons">
                            <a href="#new-arrival" class="button button-white">New Arrival</a>
                            <a href="{{ route('shop.index') }}" class="button button-white">Browse Catalogue</a>
                        </div>
                    </div> <!-- end hero-copy -->
